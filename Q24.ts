...
console.log(Name.toLowerCase() == 'john'); // Use toLowerCase() to compare case-insensitively
...
console.log(text.toLowerCase() == 'hello world'); // Compare with 'hello world' instead
